    ...
    <div class="container">
        ...
        <div class="data">
            ...
            <div class="accordion">
                <div class="accordion-item">
                    <a>
                        هل هناك شروط للتسجيل ؟
                    </a>
                    <div class="content">
                        <p>
                            1/ أن يكون العمر 18 سنه و أعلى .
                        </p>
                        <p> 2/ أن يكون سليم ذهنياً وبدنياً . </p>
                        <p> 3 / ان يكون شغوفاً في مجال مبيعات </p>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    <a>
                        هل سآخذ ورشة تدريب تسجيل أم حضور مباشر ؟
                    </a>
                    <div class="content">
                        <p>
                            حضور الورشة مباشر على الزوم , لا يوجد تسجيل أو ارسال دورات مسجله .
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    <a>
                        في حال عدم رغبتي في استكمال الدورة واستعادة أموالي ؟
                    </a>
                    <div class="content">
                        <p>
                            - عند أبلاغنا قبل بدء الورشة بـ24 ساعه سيتم استعادتها بالكامل.
                        </p>
                        <p> - خلال 24 ساعه سيتم خصم 15% قيمة رسوم تكاليف للمقعد </p>
                        <p> - بعد حضور الورشة لا يمكن استرداد القيمة . </p>
                    </div>
                </div>
            </div>
            <div class="accordion">
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="content">
                        <p>  نسبة التوظيف عالية لدينا حيث اننا نملك عدة شركات شركاء لنا تثق في متدربين إنتقاء .
                        </p>
                    </div>
                </div>
            </div>

...
?>
    <div class="company">
        <div class="contact_hero fav_hero">
            <div class="overlay">
                <div class="container">
                    <div class="data">
                ...
                <div class="data">
                    <div class="row">
                        ...
                        <div class="topnav">
                            ...
                            <?php
                            $stmt = $connect->prepare("SELECT * FROM ind_register WHERE ind_status = 2 ORDER BY order_number ASC");
                            $stmt->execute();
                            $alluser = $stmt->fetchAll();
                            $count = $stmt->rowCount();
                            if ($count > 0) {
                            ?>
                                <form action="fav_stars" method="get">
                                    <div class="row">
                                        <div class="col-5">
                        ...
                        if (isset($_GET['ind_gender'])) {
                            ...
                            if ($ind_gender_val != 'الكل' && $ind_address_val != 'الكل') {
                                $stmt = $connect->prepare("SELECT * FROM ind_register WHERE ind_status =2 
                        ...
                        if ($count > 0) {
                            ...
                            if ($com_data['com_balance'] < 1) { ?>
                                <div class="alert alert-info col-12"> لا يمكنك مشاهدة تفاصيل المتدرب حتي يتم شحن الرصيد الخاص بك اقل
                                    مبلغ هو <strong> 1 ريال </strong> وانتظر التفعيل من الادارة </div>
                            <?php
                            }
                            ...
                            ?>
                            <div class="alert alert-danger"> لا يوجد افراد مؤهلين متميزين في الوقت الحالي </div>
                        <?php
                        }

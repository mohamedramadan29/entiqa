        ...
        <section class="section section-md contact_us">
            <div class="container">
                ...
                <div class="register_form">
                    <a href="index" class="btn btn-primary" style='background-color:var(--main-color);
                 border-color:var(--main-color);width: 100px;border-radius: 5px;'><i class="fa fa-arrow-right"></i> رجوع
                    </a>
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form class="login register_new" method="post" action="" autocomplete="off">
                                <div class="row row-10">
                                    <div class="col-lg-6">
                                        <div class="box">
                                            <input pattern="[a-zA-Z]+" minlength="4" maxlength="50" required oninvalid="setCustomValidityArabic(this,' خطأ ،  يرجى كتابة بالاحرف الانجليزيه وتأكد من عدم وضع مساحة أو علامة ترقيم أو أحرف أقل من 4 ')" oninput="resetCustomValidity(this)" class="form-input" id="com_username" type="text" placeholder="   اسم المستخدم  (مطابق لاسم الشركه)  *   " name="com_username" value="<?php if (isset($_REQUEST['com_username'])) {

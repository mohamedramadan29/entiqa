                        ...
                        if ($stmt) {
                            ...
                            try {
                                ...
                                $mail->Body = " <p style='font-size:18px; font-family:inherit'>مرحبا " . $com_name . ",</p>
                                                ...
                                                <a  style='font-size:18px; font-family:inherit' href='http://entiqa.online/entiqa_test/company/activate?active_code=$activationCode' class='btn btn-primary'> أضغط هنا لتفعيل الحساب الخاص بك  </a>
                                            ";

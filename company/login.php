                ...
                if ($count_users > 0) {
                    ...
                    try {
                        ...
                        $mail->Body = " <p style='font-size:18px; font-family:inherit'>مرحبا " . $ind_username . ",</p>
                                                    ...
                                                    <a  style='font-size:18px; font-family:inherit' href='https://entiqa.online/entiqa_new/company/activate?active_code=$activationCode' class='btn btn-primary'> أضغط هنا لتفعيل الحساب الخاص بك  </a>
                                            ";

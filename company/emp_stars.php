<?php
$pagetitle = ' مؤهلين تم توظيفهم ';
ob_start();
session_start();
$com_navbar = 'com';
include 'init.php'; ?>
<div class="company">
    <div class="contact_hero emp_stars">
        <div class="overlay">
            <div class="container">
                <div class="data">
                    <h2> مؤهلين تم توظيفهم </h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="data">
                <div class="row">
                    ...
                    <div class="topnav">
                        ...
                        <?php
                        $stmt = $connect->prepare("SELECT * FROM ind_register WHERE ind_status = 3 ORDER BY order_number ASC");
                        $stmt->execute();
                    ...
                    if (isset($_GET['ind_gender'])) {
                        ...
                        if ($ind_gender_val != 'الكل' && $ind_address_val != 'الكل') {
                            $stmt = $connect->prepare("SELECT * FROM ind_register WHERE ind_status =3 
                    ...
                    if ($count > 0) {
                        ...
                        ?>
                        <div class="alert alert-danger"> لا يوجد افراد مؤهلين تم توظيفهم في الوقت الحالي </div>
                    <?php
                    }

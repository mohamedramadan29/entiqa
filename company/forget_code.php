        ...
        <div class="data">
            <form class="message_form" action="#" method="post">
                <div class="box">
                    ...
                    ?>
                    <p class="alert alert-success"><?php echo $_SESSION['mail']; ?>  تم ارسال كود الي البريد الإلكتروني الخاص بك </p>
                ...
                <div class="box">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        $code = $_POST["code"];
                        $stmt = $connect->prepare("SELECT code FROM company_register WHERE code= ?");

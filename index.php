...
<div class="landing_page" style="background-color:white;">   
    ...
    <div style="text-align: center;font-size:25px;color:#fff; margin-top:120px;font-weight:bold"
     class="">
    <img src="images/main_logo.png" style="width: 200px; height: 120px;" alt="">
                ...
                <a href="company/index">
                    <div class="section2 main_section animate__animated animate__backInRight ">
                        <div class="section_data">
                            <button class="hover" id="danger" style="background-color:#df4365;border-radius:6px;border:none;font-size:17px;color:#ffff;padding:11px"><p>
 للشركات 

<div class="container customer_report">
    <div class="data">
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> صفقات تم الاتفاق عليها بين الشركات والافراد </li>
                </ol>
            </nav>
        </div>
        ...
        <?php
        $stmt = $connect->prepare("UPDATE contract_complete SET con_com_admin=1 WHERE con_com_admin=0");
        $stmt->execute();
        ?>
        ...
        <div class="table-responsive">
            <table id="tableone" class="table table-light table-striped table-hover table-bordered">
                ...
                <tbody> <?php
                        $i = 1;
                        $stmt = $connect->prepare('SELECT * FROM contract_complete
                        INNER JOIN company_register ON company_register.com_id = contract_complete.company_id
                        INNER JOIN ind_register ON ind_register.ind_id = contract_complete.ind_id ORDER BY con_com_id DESC');
                        $stmt->execute();
                        ...
                        foreach ($alltype as $type) { ?> <tr>
                            ...
                            <td> <?php echo $type['con_com_price']; ?> </td>
                            <td> <?php
                                    $shortDate = date("Y-m-d", strtotime($type['con_com_date']));
                                    echo $shortDate;
                                    ?> </td>
                            <td>
                                            ...
                                            <form class="form-group insert ajax_form" action="#" method="POST" autocomplete="on" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="box2"> <label id="name_en">درجة الحضور<span> * </span></label>

...
$ind_data = $stmt->fetch();
// UPDATE MESSAGE NOTI
$stmt = $connect->prepare("UPDATE chat SET admin_noti = 1 WHERE to_person='admin' AND admin_noti = 0 AND send_type='ind'");
$stmt->execute();
if ($stmt) {
?>
<?php
...
<script type="text/javascript">
    $(document).ready(function() {
        setInterval(function() {
            ...
            $.ajax({
                type: "POST",
                url: "main_ajax.php?dir=chat&page=fetch_msg&ind_username=" + ind_username + '&admin_name=' + admin_name,
                dataType: "html",

<?php
// get the marketer info 
if (isset($_GET['market_id'])) {
    $marker_id = $_GET['market_id'];
    $stmt = $connect->prepare("SELECT * FROM marketers WHERE id = ?");
    $stmt->execute(array($marker_id));
    $marker_data = $stmt->fetch();

    // get the users [ ind registertion ]
    ...
    <div class="data">
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page"> تسجيلات الافراد من خلال المسوق [ <?php echo $marker_data['name']; ?> ] </li>
                    <br>
                    <li> <span class="badge badge-info"> عدد المسجلين :: <?php echo $count_ind; ?> </span> </li>
                </ol>
            </nav>
        </div>
        <?php
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    ?>
                                                                        <div class="box2">
                                                                            ...
                                                                            <select readonly disabled class="form-control select2" name="ind_status">

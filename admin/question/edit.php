        ...
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> عرض السوال </li>
                </ol>
            </nav>
        </div>
        <?php
                        ...
                        <div class="col-lg-12">
                            <div class="box2">
                                <label id="name"> السوال
                                    <span> * </span> </label>
                                <input required class="form-control" type="text" name="ques_ques" value="<?php echo $question_data['ques_ques']; ?>">
                            </div>
                            <br>
                            <br>
                            <p class="alert alert-default-info"> اختيارات السوال ! </p>
                            <?php
                            ...
                            ?>
                                <div class="box">
                                    ...
                                    <textarea rows="2" name="answer[]" required="" class="form-control"> <?php echo $question_option_data[$i][1] ?></textarea>
                                    <label><input type="radio" <?php if ($question_option_data[$i][3] == 1) echo "checked"; ?> name="is_right[]" class="is_right" value="1"> <small> الاجابة الصحيحة </small></label>
                                </div>
                            <?php
                            }
                            ?>
